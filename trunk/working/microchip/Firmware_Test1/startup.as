	...
	; HI-TECH C Compiler for PIC10/12/16 MCUs V9.71a
	...
	; Compiler options:
	;
	; -oZuVo300MCU.cof -mZuVo300MCU.map --summary=default --output=default \
	; zuvo300_main.p1 --chip=16F1823 -P --runtime=default --opt=default \
