...
static uint8_t myip[4] = {192,168,101,25};
...
uint16_t print_webpage(uint8_t *buf,uint8_t on_off)
{
        ...
        plen=fill_tcp_data_p(buf,plen,PSTR("</center><hr><br>version 2.10, tuxgraphics.org www.the0.net\n"));
        return(plen);
}
...
int main(void){
        ...
        */
        ...
        // enc28j60PhyWrite(PHLCON,0b0000 1011 1010 01 10);
 //       enc28j60PhyWrite(PHLCON,0xba6);	//0xba6	  
        delay_ms(20);
